...
class EProiezione{
      ...
      public function costruttore (string $f, string $s, string $g,string $o, string $m, string $t, int $id){
             $this->set_film($f);
             $this->set_sala($s);
             $this->set_giorno($g);
             $this->set_orario($o);
      ...
      public function set_film(string $valore){$this->film=$valore;}
      public function set_sala(string $valore){$this->sala=$valore;}
